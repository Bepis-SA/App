...
{
    [DbContext(typeof(BepixploreDbContext))]
    [Migration("20260201010316_Make_ErrorMessage_Nullable")]
    partial class Make_ErrorMessage_Nullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bepixplore.Destinations.Destination", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Bepixplore.Experiences.TravelExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TravelExperiences", (string)null);
                });

            modelBuilder.Entity("Bepixplore.Favorites.Favorite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bepixplore.Metrics.ApiMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bepixplore.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bepixplore.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bepixplore.Destinations.Destination", b =>
                {
                    b.OwnsOne("Bepixplore.Destinations.Coordinates", "Coordinates", b1 =>
                        {
            ...
            modelBuilder.Entity("Bepixplore.Ratings.Rating", b =>
                {
                    b.HasOne("Bepixplore.Destinations.Destination", null)
                        .WithMany()
                        .HasForeignKey("DestinationId")
