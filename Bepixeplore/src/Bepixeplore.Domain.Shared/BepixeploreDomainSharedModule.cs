...
public class BepixeploreDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BepixeploreGlobalFeatureConfigurator.Configure();
        BepixeploreModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BepixeploreDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BepixeploreResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Bepixeplore");

            options.DefaultResourceType = typeof(BepixeploreResource);
        ...
        {
            options.MapCodeNamespace("Bepixeplore", typeof(BepixeploreResource));
        });
    }
}
